...
I'm a passionate Computer Science student with a strong foundation in data analytics and machine learning.
I enjoy solving real-world problems through data, building end-to-end analysis pipelines, and exploring AI/ML techniques.

I hold the **Google Data Analytics Professional Certificate**, with hands-on experience in data cleaning, visualization, and storytelling. I'm currently deepening my skills in **Machine Learning and NLP** as part of my coursework and independent projects — working toward an AI/ML-focused Final Year Project.
...
| 🎯 3D Raytracer | Implemented a C++ raytracer with ray-sphere intersection, reflections, refraction, and diffuse shading. Output rendered as .ppm/.png. Adapted from Scratchapixel for learning computer graphics. | C++ |
